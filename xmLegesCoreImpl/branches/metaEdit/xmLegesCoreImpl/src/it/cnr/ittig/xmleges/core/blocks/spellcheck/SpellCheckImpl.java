...
public class SpellCheckImpl implements SpellCheck, Loggable, Serviceable, Initializable {
	...
	public void initialize() throws Exception {
		...
		// copia dictName in dictPath se non esiste gi�
		...
		if (null==checker){
		  try{	
			...
			try{	//Intercetto se � scaduta la demo della libreria "xsc.jar"
	...
	public void addSuggestion(String word, String suggestion, boolean temporaryDict) {		
		...
		try {		
	      ...
	      //se la parola ERRATA � corretta con una NON PRESENTE fra i suggerimenti
	      if (!isSuggestion(word, suggestion)) {
		         ...
		         //Salva il dizionario utente (QUESTO pu� essere MESSO ALTROVE)
