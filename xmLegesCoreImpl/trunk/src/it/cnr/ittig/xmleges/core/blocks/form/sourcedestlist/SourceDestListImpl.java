package it.cnr.ittig.xmleges.core.blocks.form.sourcedestlist;
...
import it.cnr.ittig.xmleges.core.services.form.sourcedestlist.SourceDestList;
...
/**
 * <h1>Implementazione del servizio <code>form.sourcedestlist.SourceDestList</code>.</h1>
 ...
 */
public class SourceDestListImpl implements SourceDestList, Loggable, Serviceable, Configurable, Initializable {
	Logger logger;
	...
	public void initialize() throws java.lang.Exception {
		form.setMainComponent(getClass().getResourceAsStream("/forms/SourceDestList.jfrm"));
		...
		addButton.setAction(utilUi.applyI18n("editor.forms.sourcelist.button.add", new AddAction()));
		remButton.setAction(utilUi.applyI18n("editor.forms.sourcelist.button.remove", new RemAction()));
	}
