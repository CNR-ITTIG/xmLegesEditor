...
echo ""
$IZPACK_HOME/bin/compile install-linux.xml -b . -o xmLegesEditor-2.0.x.linux.jar -k standard
$IZPACK_HOME/bin/compile install-win32.xml -b . -o xmLegesEditor-2.0.x.win32.jar -k standard
