 ...
 */
public class DocumentOpenedEvent extends DocumentManagerEvent {

	/**
	 * Costruttore dell'evento.
	 * 
	 * @param source sorgente che emette l'evento
	 * @param document documento aperto
	 */
	public DocumentOpenedEvent(Object source, Document document) {
