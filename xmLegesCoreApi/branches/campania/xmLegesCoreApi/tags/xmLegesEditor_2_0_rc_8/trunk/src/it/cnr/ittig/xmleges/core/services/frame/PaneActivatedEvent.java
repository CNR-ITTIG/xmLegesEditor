...
/**
 * Classe per notificare attraverso l'EventManager che un pannello &egrave;
 * diventato attivo.
 * <p>
 * <dl>
 ...
 */
public class PaneActivatedEvent extends PaneEvent {

	/**
	 * Costruisce l'evento impostando la sorgente e il pannello che &egrave;
	 * diventato attivo.
	 * 
	 * @param source sorgente dell'evento
	 * @param pane pannello che ha subito la variazione
	 */
	public PaneActivatedEvent(Object source, Pane pane) {
		super(source, pane);
	}
