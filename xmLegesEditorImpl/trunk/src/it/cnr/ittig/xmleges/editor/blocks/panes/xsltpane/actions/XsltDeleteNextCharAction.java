...
public class XsltDeleteNextCharAction extends XsltAction {
	...
	XsltForwardAction xsltForwardAction;

	public XsltDeleteNextCharAction() {
		super(DefaultEditorKit.deleteNextCharAction);
	}

	public void setForwardAction(XsltForwardAction xsltForwardAction) {
		this.xsltForwardAction = xsltForwardAction;
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (!leaf.isEmpty() && (tmpCaret != leaf.getEndOffset() || selStart != selEnd)) {
			int newCaretPos;
			if (selStart == selEnd) {
				newCaretPos = tmpCaret;
			} else {
