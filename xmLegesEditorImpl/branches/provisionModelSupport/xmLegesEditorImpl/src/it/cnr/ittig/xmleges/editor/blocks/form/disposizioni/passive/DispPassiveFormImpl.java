...
public class DispPassiveFormImpl implements DispPassiveForm, EventManagerListener, Loggable, ActionListener, Serviceable, Initializable, FormClosedListener {
	...
	public void setMeta() {
			...
			if (domDisposizioni.setDOMDisposizioni("#"+posDisposizione, evento.getText(), partizione, "#"+idNovellando, "#"+idNovella, preNota, autoNota, postNota, implicita.isSelected(),eventoriginale, eventovigore)==null)
