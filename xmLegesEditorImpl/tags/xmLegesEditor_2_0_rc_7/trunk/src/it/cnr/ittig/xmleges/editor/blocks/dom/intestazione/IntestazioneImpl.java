package it.cnr.ittig.xmleges.editor.blocks.dom.intestazione;
 ...
 */
public class IntestazioneImpl implements Intestazione, Loggable, Serviceable, Configurable, Initializable {
	Logger logger;
